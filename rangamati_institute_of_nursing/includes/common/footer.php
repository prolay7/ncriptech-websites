                        ...
                        <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                            <div id="text-2" class="widget widget_text kingster-widget">
                                <div class="textwidget">
                                    <p><img src="public/img/logo.png" alt=""  style="
    background-color:white;border-radius: 10px;
" />
                                        <br /> <span class="gdlr-core-space-shortcode" id="span_1dd7_10"></span>
                                        <br /> Vill- Banior,P.O- Banior, P.S- Nalhati, Dist- Birbhum,Pin- 731243, West Bengal(India)
                                      </p>
                                    <p><span id="span_1dd7_11">Admission : 7407584637 |<br> College : 9732645057</span>
                                        <br /> <span class="gdlr-core-space-shortcode" id="span_1dd7_12"></span>
                                        <br /> <a id="a_1dd7_8" href="mailto:admin@kingsteruni.edu">office.rinnursing@gmail.com
</a></p>
