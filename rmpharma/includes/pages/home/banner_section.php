...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselExample" data-bs-slide-to="0" class="active img-thumbnail" aria-current="true" aria-label="Slide 1"><img src="public/img/rmpharma/Banner1.webp" class="d-block width-100"></button>
    <button type="button" data-bs-target="#carouselExample" data-bs-slide-to="1" aria-label="Slide 2"><img src="public/img/rmpharma/Banner2.webp" class="d-block width-100"></button>
    <button type="button" data-bs-target="#carouselExample" data-bs-slide-to="2" aria-label="Slide 3"><img src="public/img/rmpharma/Banner1.webp" class="d-block width-100"></button>
  </div>
                ...
                <div class="col-lg-12 col-md-7 text-center">
                  ...
                  <h1 data-animation="fadeInUp" data-delay=".6s" class="wow fadeInUp animated" style="animation-delay: 0.6s;"><?php echo $slide['title1']; ?></h1>
                    ...
                    <div class="second-header-btn" data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.4s;">
                                            ...
                                            <div class="second-header-btn"data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.4s;">
                                               <a href="contact.html" class="btn">Courses</a>
                                            </div>
      </div>
                  </div>
                </div>
