...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselExample" data-bs-slide-to="0" class="active img-thumbnail" aria-current="true" aria-label="Slide 1"><img src="public/img/rmpharma/slider1.jpg" class="d-block width-100"></button>
    <button type="button" data-bs-target="#carouselExample" data-bs-slide-to="1" aria-label="Slide 2"><img src="public/img/rmpharma/slider2.jpg" class="d-block width-100"></button>
    <button type="button" data-bs-target="#carouselExample" data-bs-slide-to="2" aria-label="Slide 3"><img src="public/img/rmpharma/slider3.jpg" class="d-block width-100"></button>
    <button type="button" data-bs-target="#carouselExample" data-bs-slide-to="3" aria-label="Slide 4"><img src="public/img/rmpharma/slider5.jpg" class="d-block width-100"></button>
  </div>
