                ...
                <div class="row g-5 align-items-center">
                        ...
                        <div class="section-title center-align mb-50 wow fadeInDown   animated" data-animation="fadeInDown" data-delay=".4s" style="visibility: visible; animation-name: fadeInDown;">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="about-edu" role="tabpanel">
                                    <p>We are committed to impart quality “Education and Training” in Pharmacy course details that satisfy the requirements of our students in the fields of “Engineering, Pharmacy and Management” and our aim is to be an institute of excellence in global terms in the field of quality technical education through continual improvement.</p>
                                    <!-- <ul class="features-list">
                                    <i class="fal fa-long-arrow-right"></i>
                                        <li >Education award achived</li>
                                        <i class="fal fa-long-arrow-right"></i>
                              
                                        <li>Available diploma courses</li>
                                        <i class="fal fa-long-arrow-right"></i> 
                                    </ul> -->
                                </div>
                                ...
                                <div class="tab-pane fade" id="about-vision" role="tabpanel">
                                    ...
                                    <!-- <ul class="features-list">
                                        ...
                                        <li>PCI (Pharmacy Council of India), WBSCTVE&amp;SD, and Higher Education, Govt. of West Bengal.</li>
                                    </ul> -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-image-gallery">
                            <img class="main-img-1 sal-animate" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800" src="public/img/pharma/about_2.webp" alt="About Image">
                            <img class="main-img-2 sal-animate" data-sal-delay="100" data-sal="slide-left" data-sal-duration="800" src="public/img/pharma/about_1.webp" alt="About Image">
