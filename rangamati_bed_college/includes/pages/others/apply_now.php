<section class="apply">
	...
	<header class="header_apply">
		<h3 id="title" class="text-center">Application Form For B.ed & D.el.ed 2024-2025</h3>
	...
	<div class="form-wrap">	
		<form id="survey-form">
			...
			<div class="row">
				<div class="col-md-4">
					<button type="submit" id="submit" class="btn default-btn btn-block">Submit</button>
				</div>
			</div>
